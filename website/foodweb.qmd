...
Food chains illustrate predator prey interactions where (A): primary producers are at the bottom of the food web (green), followed by primary consumers (yellow), secondary consumers (orange), tertiary consumers (red), and apex predators at the top (purple)[^1]. Communities are made up of many food chains, and can get complex fast. (B) With hundreds of species (dots) and interactions (links between dots), food webs are a useful tool to capture those complex interactions.

[^1]: Image credits: Puma concolor - Moutain lion by Gabriela Palomo-Munoz CC BY 3.0, Vulpes vulpes - Red Fox by Rebecca Groom CC BY 3.0, Oreortyx pictus - Mountain Quail by Gabriela Palomo-Munoz CC BY 4.0, Oncopeltus fasciatus - Milkweed bug by Andy Wilson CC0 1.0 Universal Public Domain, Asclepias syriaca - Common Milkweed by Ian Medeiros CC BY 4.0.

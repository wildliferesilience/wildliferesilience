...
Food webs illustrate predator prey interactions where (A): primary producers are at the bottom of the food web (green), followed by primary consumers (yellow), secondary consumers (orange), tertiary consumers (red), and apex predators at the top (purple). (B) Communities can have hundreds of species (dots) and interactions (links between dots) and food webs are a useful tool to capture that complexity.  

![](SVG_images/FoodWeb_Circle_Chain_InvertCol.svg){fig-align="center"}

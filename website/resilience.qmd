...
One goal of conservation and management is to support the health and resilience of forested landscapes. Biodiversity is important for enhancing both. However, evaluating resilience alone or links between biodiversity, health and resilience is challenging. To address this challenge, the Wildlife Community Resilience Project is developing metrics to bring biodiversity and forest structure together to quantify and evaluate wildlife community health and resilience. 
...
***Resilience is a dynamic process,*** below is a diagram that illustrates resilience in a complex system (green surface). As the system evolves, it's current 'state' is defined by a ball travelling to different positions along the surface. Deeper 'troughs' represent increased resilience. If a disturbance can push the system sufficiently far (e.g. push a ball out of a trough) then the system can move to a new state (follow the dashed arrow to the new trough on the right).

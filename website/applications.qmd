...
::: columns
::: {.column width="50%"}
***Functional similarity*** is generally alike in the two forests.[^1]
...
::: columns
::: {.column width="50%"}
While similar, on average ***maximum chain length*** (calculated as the mean guild maximum chain length (mcl)) is higher in mixed conifer compared to red fir forest.[^1]
...
::: columns
::: {.column width="50%"}
***Modularity*** is similar and generally high for both forest types.[^1]

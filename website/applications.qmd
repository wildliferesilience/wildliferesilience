...
::: columns
::: {.column width="50%"}
***Species (A) and guild richness (B - functional groups)*** are higher in mixed conifer forests compared to red fir forests.[^1] This matches our knowledge of the systems, and, just because red fir forest is less biodiverse (lower species & guild richness), doesn't mean it's less valuable, they are different.

...
<img src="SVG_images/Richness_RFR_SMC.svg" alt="food web"/>

::: overlay
::: text
Figure 1: Mean values (circles) with standard deviation (error bars) produced from over 500 simulations of species level networks for a mixed conifer forest, mid seral stage, moderate canopy cover at 1900 m of elevation (blue), and a red fir forest, mid seral stage, moderate canopy cover at 2250 m elevation (red).
:::
:::
:::
...
<img src="SVG_images/Function_RFR_SMC.svg" alt="food web"/>

::: overlay
::: text
Figure 2: Mean values (circles) with standard deviation (error bars) produced from over 500 simulations of species level networks for a mixed conifer forest, mid seral stage, moderate canopy cover at 1900 m of elevation (blue), and a red fir forest, mid seral stage, moderate canopy cover at 2250 m elevation (red).
:::
:::
:::
...
<img src="SVG_images/MCL_RFR_SMC.svg" alt="food web"/>

::: overlay
::: text
Figure 3: Mean values (circles) with standard deviation (error bars) produced from over 500 simulations of species level networks for a mixed conifer forest, mid seral stage, moderate canopy cover at 1900 m of elevation (blue), and a red fir forest, mid seral stage, moderate canopy cover at 2250 m elevation (red).
:::
:::
:::
...
<img src="SVG_images/Modularity_RFR_SMC.svg" alt="food web"/>

::: overlay
::: text
Figure 4: Mean values (circles) with standard deviation (error bars) produced from over 500 simulations of species level networks for a mixed conifer forest, mid seral stage, moderate canopy cover at 1900 m of elevation (blue), and a red fir forest, mid seral stage, moderate canopy cover at 2250 m elevation (red).
:::
:::
:::

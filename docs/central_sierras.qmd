...
::: popout
![](SVG_images/TCSI_map_density.svg){alt="resilience" fig-align="center" width="100%"}
...
![Figure 2: The vegetation types that occur in the Lake Tahoe basin vary spatially (A) and in their occurrence at different elevations (B). Colors used for vegetation types in B correspond to vegetation type colors in A.](SVG_images/LTB_map_Dist.svg){alt="resilience" fig-align="center" width="100%"}
...
::: popout
![](SVG_images/LTB_Overlap_Dist.svg){alt="resilience" fig-align="center" width="100%"}

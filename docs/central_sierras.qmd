...
Lake Tahoe basin supports high biodiversity, including over 1,200 species of plants and animals. The basin also has a steep elevational gradient which means that it spans four life zones: lower montane, upper montane, subalpine, and alpine. Eight major vegetation types are common within the Lake Tahoe basin (A) and they range in their density across the elevational gradient (B[^3]).

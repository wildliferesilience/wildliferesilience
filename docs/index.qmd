...
***Integrating biodiversity into plans for resilience management*** will provide a more holistic picture of wildlife communities and will be critical for how we track, regenerate, and steward forests to be more resilient into the future. To achieve this, our team from the United States Forest Service and the California Academy of Sciences is working to measure wildlife communities' resilience by borrowing methods from paleontology[^1] to develop models of interacting wildlife species for different Sierra Nevada forests. This work is made possible by generous funding from the Wildlife Conservation Board[^2].
